<div class="container py-8">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a class="ml-6 cursor-pointer hover:text-red-600" wire:click="delete('{{ $item->rowId}}')"
                            wire:loading.class="text-red-600 bg-opacity-25" wire:target="delete('{{ $item->rowId}}')">
    ...
    <div class="bg-white rounded-lg shadow-lg px-6 py-4 mt-4">
        <div class="flex justify-between items-center">
            ...
            <div>
                <x-button-enlace href="{{ route('orders.create') }}" color="orange" class="max-w-md mx-0 p-2 mt-2">
                    Continuar
                </x-button-enlace>
            </div>
        </div>
